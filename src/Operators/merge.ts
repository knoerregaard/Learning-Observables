...
const locations = new BehaviorSubject({"locations":[{"lat":56,"long":7},{"lat":56,"long":7}],"final":{"lat":56,"long":7}})
const currentLocation =  new BehaviorSubject<any>({ lat : 54, long : 3 });

const merged = merge(locations, currentLocation);
